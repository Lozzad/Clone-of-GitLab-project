...
function addHouses() {
    ...
    //     schema: {default: ''},
    //     init() {
    //         const sky = document.querySelector('a-entity');
    ...
    // var el = document.querySelector('#'+houses[1].id);
    ...
    // //      var bbox = new THREE.Box3().setFromObject(house);
    ...
    // // // var bbox = house.object3D.geometry.boundingBox.clone();
    // // console.log(house.object3D);
    // // // var bbox1 = new THREE.Box3().setFromObject();
    // // // var bbox = house.object3D.geometry.boundingBox.clone();

    // // console.log(bbox1.min, bbox1.max);
